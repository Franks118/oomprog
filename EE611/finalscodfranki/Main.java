...
public class Main {
	...
	private void initialize() {
		...
		btnNetWages.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnNetWages.setBounds(322, 10, 120, 30);
		...
		btnPaySlip.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnPaySlip.setBounds(568, 409, 103, 39);
		...
		btnExit.setBounds(681, 409, 103, 39);
		panel_1.add(btnExit);
		...
		lblNewLabel_4_2_1_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		lblNewLabel_2_8_1.setFont(new Font("Tahoma", Font.BOLD, 15));
